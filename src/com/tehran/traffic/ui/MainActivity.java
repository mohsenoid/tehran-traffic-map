...
public class MainActivity extends Activity implements OnClickListener,
		DialogInterface.OnClickListener, OnTileListener, OnNavigationListener {
	...
	enum ApplicationState {
		Traffic, Zoom, Plane, Metro, Brt, News, Contact, About
	}
